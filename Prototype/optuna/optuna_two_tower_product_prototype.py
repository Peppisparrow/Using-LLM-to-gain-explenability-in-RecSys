...
def objective_function(trial, URM_train, URM_test, item_embeddings=None, user_embeddings=None):
    ...
    n_layers= trial.suggest_int("n_layers", 2, 8) # soft version had (2,5)
...
def main():
    ...
    optuna_study = optuna.create_study(direction="maximize", study_name=STUDY_NAME, load_if_exists=True, storage="sqlite:///{DB_PATH}", sampler=optuna.samplers.TPESampler(seed=43))
