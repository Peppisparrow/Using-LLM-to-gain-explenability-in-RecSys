...
from RecSysFramework.Recommenders.Neural.TwoTowerEMultLoss import TwoTowerRecommender
...
def objective_function(trial, URM_train, URM_test, item_embeddings=None, user_embeddings=None):
    ...
    recommender.fit(epochs=epochs, batch_size=batch_size, optimizer=optimizer, loss_type='bpr')
...
if __name__ == "__main__":
    parser = ArgumentParser(description="Run Optuna study for Two Tower Product BPR Recommender")
