...
def objective_function(trial, URM_train, URM_test, item_embeddings=None, user_embeddings=None):
    ...
    #strategy = trial.suggest_categorical("fusion_strategy", ['concatenate', 'add', 'weighted_sum', 'gated'])
    strategy = STRATEGY
...
if __name__ == "__main__":
    ...
    parser.add_argument("--strategy", type=str, help="Fusion strategy for the recommender", default='concatenate')
