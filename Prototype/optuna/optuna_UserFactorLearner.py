...
def main():
    data_manager = DataManger(data_path=DATA_PATH, item_embeddings_path=ITEM_EMBEDDING_PATH, user_key='user_id', item_key='item_id')
...
if __name__ == "__main__":
    ...
    print(f"Running study: {STUDY_NAME} with data path: {DATA_PATH}")
    ...
    print(f"Running study: {STUDY_NAME} with data path: {DATA_PATH}", file=sys.stderr)
