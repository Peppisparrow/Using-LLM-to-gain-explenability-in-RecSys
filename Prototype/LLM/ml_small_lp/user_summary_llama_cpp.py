...
OUTPUT_PATH = Path('Prototype/Dataset/ml_small/tuning/history_desc_embedding/local_summaries/user_desc_from_llm_QWEN3_30B_Q4_80K.csv')
...
Keep the tone professional, fluent, and cinematic — like a cultural critic describing a film lover’s personality.
Avoid overly ornate or academic language.
Keep the length around 400 words.

Example tone:
“Your cinematic taste is firmly anchored in the world of Crime, Thriller, and high-stakes Drama, often elevated by spectacular action. You are drawn to intense, intelligent, and meticulously crafted films that explore the darker, more complex facets of human psychology…”
"""
