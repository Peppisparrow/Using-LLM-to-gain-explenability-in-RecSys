...
datapath = "Dataset/ml/ml-1m/tuning"
prompt_path = f"{datapath}/histories_gemma_recommender_train.json"
candidate_items_path = f"{datapath}/candidate_items_30_hits.csv"
target_movies_path = f"{datapath}/histories_gemma_recommender_test.json"
output_dir = f"{datapath}/model/teprego"
output_model_path = f"{output_dir}/final_model"
MAX_USERS = 7000  # Overfitting su un piccolo sottoinsieme
