...
datapath = "Dataset/ml/ml-1m/"
# FINETUNED_MODEL_PATH = datapath+"tuning/model/teprego/checkpoint-500"  # <<< Il nome della cartella locale
# output_report_path = datapath+"tuning/model/teprego/checkpoint-500-results.json"
# CHECKPOINT_PATH = datapath+"tuning/model/teprego/checkpoint-500-results.json"
FINETUNED_MODEL_PATH = "google/gemma-3-4B-it"  # <<< Il nome della cartella locale
output_report_path = datapath+"tuning/model/gemma_pure_30.json"
CHECKPOINT_PATH = datapath+"tuning/model/gemma_pure_30.json"

TEST_SET_PATH = datapath+"final/histories_gemma_recommender_train.json"
TARGET_MOVIES_PATH = datapath+"final/histories_gemma_recommender_test.json"
candidate_items_path = datapath+"final/candidate_items_30.csv"
...
MAX_USERS = 7000  # Numero massimo di utenti da valutare (impostalo su None per tutti)
