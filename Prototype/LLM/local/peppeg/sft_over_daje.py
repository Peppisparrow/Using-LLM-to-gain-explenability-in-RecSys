...
# --- CONFIG ---
model_id = "Dataset/ml/ml-latest-small/tuning/gemmasft/onlu_title_lora/final"
...
output_dir = "Dataset/ml/ml-latest-small/tuning/gemmasft/onlu_title_lora/grpo2"
...
# --- 3. CARICA MODELLO ---
base_model_id = "unsloth/gemma-3-4b-it"  # O il modello che hai usato come base
...
# Applica l'adapter LoRA già esistente
