...
##########                                                  ##########
######################################################################
from RecSysFramework.Recommenders.NonPersonalizedRecommender import TopPop, Random, GlobalEffects

# KNN
from RecSysFramework.Recommenders.KNN.UserKNNCFRecommender import UserKNNCFRecommender
from RecSysFramework.Recommenders.KNN.ItemKNNCFRecommender import ItemKNNCFRecommender
from RecSysFramework.Recommenders.GraphBased.P3alphaRecommender import P3alphaRecommender
from RecSysFramework.Recommenders.GraphBased.RP3betaRecommender import RP3betaRecommender
from RecSysFramework.Recommenders.EASE_R.EASE_R_Recommender import EASE_R_Recommender

# KNN machine learning
from RecSysFramework.Recommenders.SLIM.Cython.SLIM_BPR_Cython import SLIM_BPR_Cython
from RecSysFramework.Recommenders.SLIM.SLIMElasticNetRecommender import SLIMElasticNetRecommender, MultiThreadSLIM_SLIMElasticNetRecommender

# Matrix Factorization
from RecSysFramework.Recommenders.MatrixFactorization.PureSVDRecommender import PureSVDRecommender, PureSVDItemRecommender
from RecSysFramework.Recommenders.MatrixFactorization.IALSRecommender import IALSRecommender
from RecSysFramework.Recommenders.MatrixFactorization.NMFRecommender import NMFRecommender
from RecSysFramework.Recommenders.MatrixFactorization.Cython.MatrixFactorization_Cython import MatrixFactorization_BPR_Cython,\
    MatrixFactorization_SVDpp_Cython, MatrixFactorization_AsySVD_Cython

from RecSysFramework.Recommenders.Neural.MultVAERecommender import MultVAERecommender_OptimizerMask as MultVAERecommender
from RecSysFramework.Recommenders.FactorizationMachines.LightFMRecommender import LightFMCFRecommender
...
##########                                                  ##########
######################################################################
from RecSysFramework.Recommenders.KNN.ItemKNNCBFRecommender import ItemKNNCBFRecommender
from RecSysFramework.Recommenders.KNN.UserKNNCBFRecommender import UserKNNCBFRecommender
...
##########                                                  ##########
######################################################################
from RecSysFramework.Recommenders.KNN.ItemKNN_CFCBF_Hybrid_Recommender import ItemKNN_CFCBF_Hybrid_Recommender
from RecSysFramework.Recommenders.KNN.UserKNN_CFCBF_Hybrid_Recommender import UserKNN_CFCBF_Hybrid_Recommender
from RecSysFramework.Recommenders.FactorizationMachines.LightFMRecommender import LightFMItemHybridRecommender, LightFMUserHybridRecommender
from RecSysFramework.Recommenders.FeatureWeighting.Cython.CFW_D_Similarity_Cython import CFW_D_Similarity_Cython
from RecSysFramework.Recommenders.FeatureWeighting.Cython.CFW_DVV_Similarity_Cython import CFW_DVV_Similarity_Cython
from RecSysFramework.Recommenders.FeatureWeighting.Cython.FBSM_Rating_Cython import FBSM_Rating_Cython

######################################################################
from skopt.space import Real, Integer, Categorical
import traceback

from RecSysFramework.HyperparameterTuning.SearchBayesianSkopt import SearchBayesianSkopt
from RecSysFramework.HyperparameterTuning.SearchSingleCase import SearchSingleCase
from RecSysFramework.HyperparameterTuning.SearchAbstractClass import SearchInputRecommenderArgs
...
def read_data_split_and_search():
    ...
    from RecSysFramework.Data_manager import Movielens1MReader
    from RecSysFramework.Data_manager.DataSplitter_Holdout import DataSplitter_Holdout
