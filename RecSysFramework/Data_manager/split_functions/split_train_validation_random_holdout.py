...
def split_train_in_two_percentage_user_wise(URM_train, train_percentage = 0.1, verbose = False):
    ...
    from RecSysFramework.Data_manager.IncrementalSparseMatrix import IncrementalSparseMatrix
    ...
    for user_id in range(URM_train.shape[0]):
        ...
        indices_for_sampling = np.arange(0, user_profile_length, dtype=np.int32)
